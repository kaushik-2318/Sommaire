...
export default async function page() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <MotionDiv initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }} className="container mx-auto flex flex-col gap-4">
        <div className="px-2 py-12 sm:py-24">
          <div className="mb-8 flex justify-between gap-4">
            <div className="flex flex-col gap-2">
              <MotionH1 variants={itemVariants} initial={'hidden'} whileInView={'visible'} viewport={{ once: true }} className="bg-linear-to-r from-gray-600 to-gray-900 bg-clip-text text-4xl font-bold tracking-tighter text-transparent">
                Your Summaries
              </MotionH1>
              <MotionP variants={itemVariants} initial={'hidden'} animate={'visible'} viewport={{ once: true }} className="text-gray-600">
            ...
            </div>
            {
              !hasReachedLimit && (
                <MotionDiv
                  variants={itemVariants} initial={'hidden'} whileInView={'visible'} whileHover={{ scale: 1.05 }} viewport={{ once: true }} className='self-start' >
                  <Button
                    variant={'link'}
