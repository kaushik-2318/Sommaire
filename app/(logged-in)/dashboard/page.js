        ...
        <div className="px-2 py-12 sm:py-24">
          <div className="mb-8 flex justify-between gap-4">
            <div className="flex flex-col gap-2">
              <MotionH1 variants={itemVariants} initial={'hidden'} whileInView={'visible'} className="bg-linear-to-r from-gray-600 to-gray-900 bg-clip-text text-4xl font-bold tracking-tighter text-transparent">
                Your Summaries
              </MotionH1>
            ...
            </div>
            {
              !hasReachedLimit && (
                <MotionDiv
                  variants={itemVariants} initial={'hidden'} whileInView={'visible'} whileHover={{ scale: 1.05 }} className='self-start' >
                  <Button
                    variant={'link'}
          ...
          {
            hasReachedLimit && (
              <MotionDiv variants={itemVariants} initial={'hidden'} whileInView={'visible'} whileHover={{ scale: 1.05 }} className="mb-6">
