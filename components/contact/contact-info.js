        ...
        <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="ml-4">
                                ...
                                <a href="tel:+917061761587" className="mt-1 block text-sm text-gray-600 hover:text-rose-600">
                                    +91 70617 61587
                                </a>
                            </div>
                        </div>
            ...
            <Card className="overflow-hidden border-rose-100/30 bg-white/80 shadow-xl backdrop-blur-md transition-all duration-300 hover:bg-white/90 hover:shadow-2xl">
                <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            <h4 className="text-base font-medium text-gray-900">How quickly will I receive a response?</h4>
                            <p className="mt-1 text-sm text-gray-600">
                        ...
                        <div>
                            <h4 className="text-base font-medium text-gray-900">Do you offer custom solutions?</h4>
                            <p className="mt-1 text-sm text-gray-600">
                        ...
                        <div>
                            <h4 className="text-base font-medium text-gray-900">How can I request technical support?</h4>
                            <p className="mt-1 text-sm text-gray-600">
                                For technical issues, please include your account details and a description of the problem in your
                                message.
                            </p>
                        </div>
                    </div>
